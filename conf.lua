-- conf.lua is parsed before love finishes initialization

-- set configuration options such as window size and 
-- other locked variables
...
function love.conf(t)
    ...
    t.window.title = "7DRL 2017"        -- The window title (string)
